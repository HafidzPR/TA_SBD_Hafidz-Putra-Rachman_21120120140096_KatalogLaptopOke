                  ...
                  <div class="card-body">
                    <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="Laptop" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->Laptop}}">
                                                          
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Merek Laptop</label>
                        <input type="text" name="Merek" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->Merek}}">
                      </div>
                      <div class="mb-3">
