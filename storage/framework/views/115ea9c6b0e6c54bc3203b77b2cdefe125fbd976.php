...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mb-5">✏️ Edit Data Laptop 💻</h1>
                  ...
                  <div class="card-body">
                    <form action="/updatedata/<?php echo e($data->id); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="Laptop" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo e($data->Laptop); ?>">
                                                          
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Merek Laptop</label>
                        <input type="text" name="Merek" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo e($data->Merek); ?>">
                      </div>
                      <div class="mb-3">
                        ...
                        <select class="form-select" name="Tipe" aria-label="Default select example">
                          <option selected><?php echo e($data->Tipe); ?></option>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" name="Harga" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo e($data->Harga); ?>">
                      </div>
...
</html><?php /**PATH D:\Applications\Apache XAMPP\htdocs\databaselaptopoke\resources\views/tampildata.blade.php ENDPATH**/ ?>